...
export DIRACX_TASKS_CONDOR_JOB_EXECUTOR_ENABLED=true
export DIRACX_TASKS_CONDOR_JOB_EXECUTOR_INTERVAL_SECONDS=10
export DIRACX_TASKS_CONDOR_JOB_STATUS_COLLECTOR_ENABLED=true
export DIRACX_TASKS_CONDOR_JOB_STATUS_COLLECTOR_INTERVAL_SECONDS=60
